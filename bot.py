...
def create_animated_progress_bar(
    ...
    try:
        fn_name = ImageFont.truetype(FONT_BOLD, 17)
        fn_disc = ImageFont.truetype(FONT_REG,  13)
        fn_lbl  = ImageFont.truetype(FONT_REG,  13)
        fn_pct  = ImageFont.truetype(FONT_BOLD, 14)
    except Exception:
    ...
    BAR_X  = TEXT_X
    BAR_W  = W - BAR_X - PAD
    BAR_H  = 18   # taller bars, rectangular
    BAR_Y1 = 84
    BAR_Y2 = 132
    ...
    for i in range(total_frames + 1):
        ...
        # ── Fonts scaled up ──
        try:
            fn_name_s = ImageFont.truetype(FONT_BOLD, 17 * SCALE)
            fn_disc_s = ImageFont.truetype(FONT_REG,  13 * SCALE)
            fn_lbl_s  = ImageFont.truetype(FONT_REG,  13 * SCALE)
            fn_pct_s  = ImageFont.truetype(FONT_BOLD, 14 * SCALE)
        except Exception:
